    ...
    def _kr_candidates(self) -> list[SecuritySnapshot]:
        ...
        return [
            SecuritySnapshot(
                ...
                fundamentals=FundamentalIndicators(5400, 15.4, 60143, 1.4, 9.8, 2.2),
            ...
            SecuritySnapshot(
                ...
                fundamentals=FundamentalIndicators(10230, 18.7, 93480, 2.1, 11.9, 1.1),
            ...
            SecuritySnapshot(
                ...
                fundamentals=FundamentalIndicators(9450, 23.6, 171538, 1.3, 6.5, 0.6),
            ...
            SecuritySnapshot(
                ...
                fundamentals=FundamentalIndicators(5510, 34.2, 78500, 2.4, 7.1, 0.4),
    ...
    def _us_candidates(self) -> list[SecuritySnapshot]:
        ...
        return [
            ...
            SecuritySnapshot(
                ...
                fundamentals=FundamentalIndicators(4.16, 41.7, 40.37, 4.3, 10.2, 0.0),
